...
const ConnectWallet = () => {
  ...
  const { fetchedWalletAddress, setFetchedWalletAddress,
      fetchedWalletId, setFetchedWalletId,
      fetchedWalletType, setFetchedWalletType } = useContext(WalletIDMainContext);
    ...
    if (window.ethereum) {
      window.ethereum.request({ method: 'eth_requestAccounts' })
        .then(result => {
          ...
          axios.post("http://127.0.0.1:8000/user/login", dataToSave)
      ...
      <div className="flex flex-col items-center justify-center text-center mt-[3rem] mx-[7rem] overflow-hidden">
        ...
        <div className="mx-[9rem] lg:mx-auto lg:w-[55rem] 2xl:w-[75rem] 2xl:mx-auto" >
          <div className="text-white items-start justify-start text-left  mt-[6rem]">
            Disclaimer : <br />
            <p className="text-sm">
              Blockright seeks wallet verification with the sole purpose of gathering
              public address information from the user to retrieve details of
              non-fungible tokens (NFTs) held in a specific wallet from
              the blockchain. It is important to note that Blockright does not
              request, acquire, or seek ownership, transfer, authentication, or
              custody of any NFTs. We advise users to exercise caution when
              connecting their wallet and signing any transaction. Be vigilant and
              mindful of potential risks, such as phishing attempts or suspicious
              transactions. By using our services, you acknowledge and agree to
              the terms and conditions stated in this legal disclaimer.
              <br /> If you do not agree with any part of this disclaimer, please
              refrain from using our website and services. If you have any
              questions or concerns regarding this legal disclaimer or our
